...
class App extends Component {
  ...
  postNewEvent() {
    ...
    axios.post("/user/newEvent", tripData).then(response => {
    ...
    return (
      <div className="App">
        ...
        <div className="container-fluid">
          ...
          <Route
            path="/ledger"
            render={() => <Ledger username={this.state.username} />}
          />
          <Route
            path="/events"
            render={() => <Events username={this.state.username} />}
          />
          <Route
            path="/trips"
            render={() => (
              <Trips owed={this.state.owed} currentUser={this.state.username} />
            )}
          />
          <Route
            path="/tripsPaid"
